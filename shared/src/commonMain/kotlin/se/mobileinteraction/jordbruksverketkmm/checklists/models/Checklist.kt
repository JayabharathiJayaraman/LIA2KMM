...
data class Checklist(val category: ChecklistCategory, val itemList: List<ChecklistItem>) {

    val title: String = "CheckList_" + category.categoryName + "_title"
    val text: String = "CheckList_" + category.categoryName + "_text"
    val id: ChecklistCategory = category
}

enum class ChecklistCategory(val categoryName: String) {
